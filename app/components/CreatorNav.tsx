...
import { Home, Briefcase, FileText, Star, LogOut, Menu, X } from "lucide-react";
...
export default function CreatorNav() {
  ...
  const menuItems = [
    { label: t("nav.profile"), icon: Home, path: "/creator/profile" },
    { label: t("nav.campaigns"), icon: Briefcase, path: "/creator/campaigns" },
    { label: t("nav.applications"), icon: FileText, path: "/creator/applications" },
    { label: t("nav.reviews"), icon: Star, path: "/creator/reviews" },
  ];

  return (
    <>
      {/* Desktop */}
      <nav className="hidden md:block bg-gradient-to-r from-purple-600 to-purple-500 text-white shadow-lg">
      ...
      {/* Mobile */}
      <nav className="md:hidden bg-gradient-to-r from-purple-600 to-purple-500 text-white shadow-lg">
